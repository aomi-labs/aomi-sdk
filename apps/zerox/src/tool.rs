...
impl DynAomiTool for GetZeroxAllowanceHolderPrice {
    ...
    fn run(_app: &ZeroxApp, args: Self::Args, _ctx: DynToolCallCtx) -> Result<Value, String> {
        ok(
            ZeroxClient::new(args.api_key.as_deref())?.get_allowance_holder_price(
                &args.chain,
                &args.sell_token,
                &args.buy_token,
                args.amount,
...
impl DynAomiTool for GetZeroxGaslessPrice {
    ...
    fn run(_app: &ZeroxApp, args: Self::Args, _ctx: DynToolCallCtx) -> Result<Value, String> {
        ok(
            ZeroxClient::new(args.api_key.as_deref())?.get_gasless_price(
                &args.chain,
                &args.sell_token,
                &args.buy_token,
                args.amount,
...
impl DynAomiTool for GetZeroxGaslessQuote {
    ...
    fn run(_app: &ZeroxApp, args: Self::Args, _ctx: DynToolCallCtx) -> Result<Value, String> {
        ok(
            ZeroxClient::new(args.api_key.as_deref())?.get_gasless_quote(
                &args.chain,
                &args.sell_token,
                &args.buy_token,
                args.amount,
...
impl DynAomiTool for SubmitZeroxGaslessSwap {
    ...
    fn run(_app: &ZeroxApp, args: Self::Args, _ctx: DynToolCallCtx) -> Result<Value, String> {
        ok(
            ZeroxClient::new(args.api_key.as_deref())?.submit_gasless_swap(
                args.chain_id,
                &args.trade,
